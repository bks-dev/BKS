...
unlocked to sign the BKS-Qt.app bundle.
...
allowing somebody to distribute a BKS-Qt.app or BKS-qt-setup.exe with a valid
...
that the BKS-qt.exe file inside the installer had not been tampered with.
