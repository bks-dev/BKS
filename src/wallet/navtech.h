...
#ifndef BKS_WALLET_BKSTECH_H
#define BKS_WALLET_BKSTECH_H
...
#define BKSTECH_DEFAULT_INPUT_DELAY 1
#define BKSTECH_DEFAULT_OUT_DELAY 10
#define BKSTECH_DEFAULT_ENTROPY 4
