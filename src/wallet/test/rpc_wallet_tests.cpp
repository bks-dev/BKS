...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBKSAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBKSAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBKSAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBKSAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBKSAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBKSAddress(arr[0].get_str()).Get() == demoAddress.Get());
