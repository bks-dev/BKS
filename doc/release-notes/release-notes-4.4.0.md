...
- Fee to create a Proposal: 50 BKS
...
You can read more about [NPIP0003 on the NPIP GitHub](https://github.com/BKS/npips/blob/master/npip-0003.mediawiki).

## Community Fund Contribution Increase

The Version Bit 16 will signal for the soft fork to increase the Community Fund contribution from 0.25 BKS to 0.50 BKS per block. 

You can read more about [NPIP0004 on the NPIP GitHub](https://github.com/BKS/npips/blob/master/npip-0004.mediawiki).
...
```
createproposal BKSaddress amount duration "desc" fee

Arguments:
1. "BKSaddress" (string, required) The BKS address where coins would be sent if the proposal is approved.
2. "amount" The amount in BKS to request. eg 100
...
2. "amount" (numeric or string, required) The amount in BKS to withdraw. eg 10
...
Donate BKS from your wallet to the commnuity fund

Arguments:
1. "amount" (string, required) The amount of BKS to donate
```
...
### Other modifications in the BKS client:
