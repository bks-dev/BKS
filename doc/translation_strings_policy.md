...
This document provides guidelines for internationalization of the BKS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `BKS_en.ts` remains unchanged.
