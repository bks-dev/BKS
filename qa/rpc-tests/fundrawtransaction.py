...
class RawTransactionsTest(BKSTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid BKS address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid BKS address" in e.error['message'])
