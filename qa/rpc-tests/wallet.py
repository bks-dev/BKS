...
class WalletTest (BKSTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BKS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BKS with subtract fee from amount
        ...
        # Sendmany 10 BKS with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/BKS/BKS/issues/7463
        #     # '-salvagewallet',
        # ]
